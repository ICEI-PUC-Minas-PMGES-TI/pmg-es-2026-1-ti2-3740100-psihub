...
[1.1] - ORACLE. **Java Platform, Standard Edition 25 Documentation**. Oracle, 2024. Disponível em: <https://docs.oracle.com/en/java/>. Acesso em: 22 jun. 2026.

[1.2] - SPRING. **Spring Boot Reference Documentation**. Spring.io, 2024. Disponível em: <https://docs.spring.io/spring-boot/>. Acesso em: 22 jun. 2026.

[1.3] - SPRING. **Spring Data JPA Reference Documentation**. Spring.io, 2024. Disponível em: <https://docs.spring.io/spring-data/jpa/docs/current/reference/html/>. Acesso em: 22 jun. 2026.

[1.4] - HIBERNATE. **Hibernate ORM Documentation**. Hibernate.org, 2024. Disponível em: <https://hibernate.org/orm/documentation/>. Acesso em: 22 jun. 2026.

[1.5] - FLYWAY. **Flyway Database Migrations**. Redgate, 2024. Disponível em: <https://flywaydb.org/documentation/>. Acesso em: 22 jun. 2026.

[1.6] - MYSQL. **MySQL 8.0 Reference Manual**. Oracle, 2024. Disponível em: <https://dev.mysql.com/doc/>. Acesso em: 22 jun. 2026.

[1.7] - APACHE. **Maven Project Documentation**. Apache Software Foundation, 2024. Disponível em: <https://maven.apache.org/guides/>. Acesso em: 22 jun. 2026.

[1.8] - DOCKER. **Docker Documentation**. Docker Inc., 2024. Disponível em: <https://docs.docker.com/>. Acesso em: 22 jun. 2026.
