...
| Percentual de pagamentos extornados | Monitorar perdas financeiras e necessidade de revisão de cobranças | Percentual de pagamentos estornados em relação ao total de pagamentos do período | Tabela pagamentos | (número de pagamentos com status_pagamento = 'ESTORNADO' / número total de pagamentos) * 100 |
