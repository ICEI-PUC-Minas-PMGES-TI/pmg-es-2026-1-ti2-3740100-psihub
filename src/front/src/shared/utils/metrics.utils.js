...
function reportMetric(name, value, attributes = {}) {
    ...
    // Envia para o endpoint configurado via VITE_METRICS_ENDPOINT (ex.: /api/metrics ou endpoint de observabilidade).
    // sendBeacon funciona mesmo quando a aba esta sendo fechada, sem bloquear o thread principal.
    ...
    if (endpoint) {
        try {
            ...
            // Nao interrompe o fluxo por falha no envio de metrica.
        }
    }
