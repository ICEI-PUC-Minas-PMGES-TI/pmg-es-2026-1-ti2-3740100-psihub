        ...
        <div className="psychologist-home">
            ...
            <header className="agenda-page__header panel">
                <div>
                    ...
                    <h1>Dashboard</h1>
                    <p className="agenda-page__subtitle">Gerencie sua prática, acompanhe seus pacientes e otimize seu tempo com nosso painel intuitivo e completo. Tenha tudo o que precisa para oferecer um atendimento de qualidade na ponta dos dedos.</p>
                </div>
            </header>
            ...
            <section className="dashboard-cards">
                ...
                <div className="panel stat-card">
                    ...
                    <strong>45</strong>
                    <small>+12% que mês anterior</small>
                </div>
            ...
            <section className="dashboard-grid">
                ...
                <div className="panel dashboard-box">
                    ...
                    <div className="dashboard-notification">
                        <strong>2 solicitações de vínculo</strong>
                        <span>Pacientes aguardando aceite</span>
                    </div>
