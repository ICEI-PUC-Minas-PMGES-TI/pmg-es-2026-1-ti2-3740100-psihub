...
import { useAgendaPatientSearchField } from '@/modules/psicologos/hooks/useAgendaPatientSearchField';
...
function PatientSearchField({ value, selectedId, onSelect, onClear }) {
    const {
        ...
        handleSelect,
        handleBlur,
    } = useAgendaPatientSearchField({ value, selectedId, onSelect, onClear });
    return (
